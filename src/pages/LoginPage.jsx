      ...
      <div className="relative w-full max-w-md">
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-neutral-500 dark:text-neutral-400">
            Sign in to manage your madrassa&rsquo;s festival.
          </p>
          ...
          <form className="mt-6 space-y-4" onSubmit={handleSubmit}>
            ...
            >
              ...
              <div className="relative">
                <MailIcon className="pointer-events-none absolute left-3.5 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-neutral-400 transition-colors peer-focus:text-[#21F1A8]" />
                <input
                  type="email"
                  required
                  value={email}
            ...
            >
              ...
              <div className="relative">
                <LockIcon className="pointer-events-none absolute left-3.5 top-1/2 h-4.5 w-4.5 -translate-y-1/2 text-neutral-400 transition-colors peer-focus:text-[#21F1A8]" />
                <input
